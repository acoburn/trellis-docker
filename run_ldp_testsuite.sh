...
mv report/ldp-testsuite-execution-report-earl.jsonld report/basic.json
...
mv report/ldp-testsuite-execution-report-earl.jsonld report/direct.json
...
mv report/ldp-testsuite-execution-report-earl.jsonld report/indirect.json
