...
java -jar ldp-testsuite.jar --software "Trellis LDP" --server http://127.0.0.1/basic --basic | grep -v DEBUG
...
java -jar ldp-testsuite.jar --software "Trellis LDP" --server http://127.0.0.1/direct --direct | grep -v DEBUG
...
java -jar ldp-testsuite.jar --software "Trellis LDP" --server http://127.0.0.1/indirect --indirect | grep -v DEBUG
